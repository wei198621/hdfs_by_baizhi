 ...
 *
 */
public class MobileAccess3Map extends Mapper<LongWritable, Text,Text,AccessLog3Writable> {
    @Override
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        context.write(new Text(values[1]),new AccessLog3Writable(upload,down,total));
    }
}
